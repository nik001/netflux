    ...
    return (
        <div className=''>
            <div className='addition-material-S'>
             ...
             <p>  Команда netflux берет на себя обеспечение бесперебойной работы офиса, в то время пока сам заказчик 
сосредоточен на своей основной деятельности. Удаленное системное администрирование возьмем на себя МЫ.</p> 
